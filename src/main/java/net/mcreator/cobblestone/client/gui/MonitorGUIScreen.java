...
import net.mcreator.cobblestone.world.inventory.MonitorGUIMenu;
import net.mcreator.cobblestone.procedures.MonitorTextProcedure;
import net.mcreator.cobblestone.procedures.MonitorProgressProcedure;
import net.mcreator.cobblestone.procedures.MonitorInformationProcedure;
import net.mcreator.cobblestone.procedures.MonitorEnergyProcedure;
import net.mcreator.cobblestone.procedures.MOnSpriteProcedure;
import net.mcreator.cobblestone.init.CobblestoneModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class MonitorGUIScreen extends AbstractContainerScreen<MonitorGUIMenu> implements CobblestoneModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("cobblestone:textures/screens/monitor_gui.png");
